...
import com.example.zenmind.TopBar
import com.example.zenmind.model.MedicalDatabaseHelper
import com.example.zenmind.model.MedicalDb
import com.example.zenmind.ui.theme.Activityscreen
import com.example.zenmind.ui.theme.fillmaxwid
import com.example.zenmind.ui.theme.fnt18
import com.example.zenmind.ui.theme.horzcenter
import com.example.zenmind.ui.theme.mobkeypad
import com.example.zenmind.ui.theme.purple673
import com.example.zenmind.ui.theme.rcshape
import com.example.zenmind.ui.theme.reglogbut
import com.example.zenmind.ui.theme.reglogbuttxtcol
import com.example.zenmind.ui.theme.subtxtcol
import com.example.zenmind.ui.theme.txtbold
import com.example.zenmind.ui.theme.txtcenter
import com.example.zenmind.ui.theme.vertspace
            ...
            onClick = {
                if (ht.value.text.isNotEmpty() && wt.value.text.isNotEmpty() && age.value.text.isNotEmpty()
                    ...
                    val usermed = MedicalDb(
                        ...
                        bmi = (wt.value.text.toFloat() * 10000 / (ht.value.text.toFloat() * ht.value.text.toFloat())).toInt().toString(),
                        age = age.value.text,
                        gender = gen.value,
